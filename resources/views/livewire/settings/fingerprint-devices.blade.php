    ...
    <x-ui.slide-over wire="showForm" :title="$editingUuid ? __('settings.fpDevices.editTitle') : __('settings.fpDevices.createTitle')">
        <form wire:submit="save" class="flex flex-1 flex-col overflow-y-auto">
            <div class="flex-1 space-y-4 p-5">
                <x-ui.input :label="__('settings.fpDevices.name')" wire:model="form_name" :placeholder="__('settings.fpDevices.namePh')" :error="$errors->first('form_name')" />
                ...
                <x-ui.input type="number" :label="__('settings.fpDevices.port')" wire:model="form_port" min="1" max="65535" :error="$errors->first('form_port')" />
            ...
            <div class="flex items-center justify-end gap-2 border-t border-line px-5 py-4">
                ...
                <x-ui.button type="submit">{{ $editingUuid ? __('settings.fpDevices.saveChanges') : __('settings.fpDevices.createDevice') }}</x-ui.button>
            </div>
        </form>
    </x-ui.slide-over>
